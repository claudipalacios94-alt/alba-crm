// ══════════════════════════════════════════════════════════════
// ALBA CRM — useProperties
// CRUD de propiedades + geocoding
// ══════════════════════════════════════════════════════════════
...
export function useProperties() {
  ...
  const loadProperties = useCallback(async () => {
    ...
    try {
      ...
      setProperties(data?.length ? data : PROPS_DEMO);
    } catch (err) {
  ...
  // Realtime
  useEffect(() => {
    const channel = supabase.channel("props-changes")
  ...
  async function updateProperty(id, updates) {
    ...
    if (error) { await loadProperties(); throw error; }
  }
